# -*- coding: utf-8 -*-
"""
Created on Mon Jun 28 19:10:11 2021
...
#Define variables 
W="||*******************************************||"#For design in the beginning of program interface
SEP="---------------------------"#for use to orgnize interface
 
def displayMenu():
    #print a head of the Menu
    print("||******************Menu*********************||")
    #Display the menu
...
def main():
    ...
    while Country=="A" or Country=="B" or Country=="a" or Country=="b":#while user choose America or Australia  
        ...
        if Country=="A" or Country=="a":
            print(SEP)#To organize the interface
    ...
    if Country=="C" or Country=="c":
        print(SEP,"\nYou have choosen to End the program!\n",SEP,"\nThanks for Using Taxation System",sep="")#Display message then end the program
